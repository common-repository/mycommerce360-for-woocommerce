...
$settings_default = array(
	...
	'normal_delivery' => array(
		'title'         => __( 'Carrier name for normal delivery', 'woocommerce-MC360'),
		'type'          => 'text',
        'description' 	=> __( 'Enter name for Carrier.' ),
		'class'         =>  'normal_delivery',
		'default'       => '',
		'desc_tip'       => true
	),
	'flex_delivery' => array(
		'title'         => __( 'Carrier name for flex delivery with text', 'woocommerce-MC360'),
		'type'          => 'text',
        'description' 	=> __( 'Enter name for flex Carrier delivery.' ),
		'class'         =>  'flex_delivery',
		'default'       => '',
		'desc_tip'       => true
	)
